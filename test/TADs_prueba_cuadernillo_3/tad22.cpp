...
*/
  ...
  a.Insertar(c30);  a.Insertar(c20);  a.Insertar(c40);  a.Insertar(c10);
  a.Insertar(c25);  a.Insertar(c35);  a.Insertar(c45);  a.Insertar(c5);
  a.Insertar(c32);  a.Insertar(c42); a.Insertar(c50);
